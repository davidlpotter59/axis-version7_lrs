/* lrspr2020c.eq
   ...
   daily Assigned Report by Coverage Attorney
*/
                                         
description Daily Assigned Report - Sorted by Coverage Attorney ;

include "startend.inc"                   

define string l_prog_number = 
"LRSPR2020d Daily Assigned Report - Coverage Attorney "
...
where lrssetup:status one of "O","R" and
      ...
      lrssetup:Coverage_vendor <> 0

list
/domain="lrssetup"
/nobanner    
/pagewidth=252  
/title="Daily Assigned Report Sorted by Coverage Attorney"
/nodefaults 
--/duplicates 

box/noblanklines
lrssetup:Coverage_vendor/heading="Adjustor-Number"/duplicates
...
sorted by lrssetup:Coverage_vendor/newpage/total 
          lrssetup:reported_date /total/newlines=2
          lrssetup:claim_no   

include "rpttopfw.inc"  
""/newline
alt_sfsvendor1:name[1]/heading="Coverage Adjustor"/newline=2
...
""/newline
count[lrssetup:units,lrssetup:Coverage_vendor]/heading=
