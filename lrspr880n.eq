...
/*  LRSPR880n
    ...
    Losses by Claim Number - Direct - Negatives

    Date Written : October 3, 2007

    SCIPS.com */
                                                   
description Losses By Claim Number - DIRECT - Liability - By Date - Negatives ;

define string l_claim_no = str(lrsdetail:claim_no) + trun(sfsline_alias:claim_alpha
)

Define String l_prog_number = "LRSPR880n - Rev 1.00"
