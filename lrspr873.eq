/*  LRSPR873
    ...
    Reserve Changes by a parameter amount - Liability Only
...
description 
Reserve changes (Liability Causes Only) by a selected amount - Requires user to enter the amount of change.  Also, this report uses a starting and ending date range.  The reserve will be compared to the prior period;

Define String l_prog_number = "LRSPR873 - Rev 4.00"
...
/nobanner
/domain="lrsdetail"
/title="Liability Losses With Reserve Changes Equal or Greater Than Selected Amount"
/pagewidth=255
/duplicates
/nodetail
/nodefaults 
