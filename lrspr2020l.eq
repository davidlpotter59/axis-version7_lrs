/* lrspr2020l.eq
   ...
   daily Assigned Report by litigation Attorney
*/
                                         
description Daily Assigned Report - Sorted by litigation Attorney ;

include "startend.inc"                   

define string l_prog_number = 
"LRSPR2020l Daily Assigned Report - litigation Attorney "
...
where lrssetup:status = "O" and
      ...
      lrssetup:litigation_vendor <> 0

list
/domain="lrssetup"
/nobanner    
/pagewidth=252  
/title="Daily Assigned Report Sorted by Litigation Attorney"
/nodefaults 
--/duplicates 

box/noblanklines
lrssetup:litigation_vendor/heading="Alitigationustor-Number"/duplicates
...
sorted by lrssetup:litigation_vendor/newpage/total 
          lrssetup:reported_date /total/newlines=2
          lrssetup:claim_no   

include "rpttopfw.inc"  
""/newline
alt_sfsvendor2:name[1]/heading="Alitigationustor"/newline=2
...
""/newline
count[lrssetup:units,lrssetup:litigation_vendor]/heading=
