/* lrslt009.eq
   ...
   Claim Acknowledgment letter - with holdback
...
"Enclosed, please find our company check for the amount of "
lrssetup_work:amount /mask="$$,$$$,$$9.99"
"."/newline
"The amount of the check includes the depreciation amount of "
lrssetup_work:depreciation_amt /mask="$$,$$$,$$9.99"
"."/newline=2
"Your claim is now paid in full and we will close our file accordingly."
/newline=2
