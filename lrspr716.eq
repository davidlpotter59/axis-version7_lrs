/*  lrspr716
    ...
    Losses by Litigation - Excel */

description  Excel - Litigation Adjustors Totals ;
...
where lrsdetail:trans_date >= l_starting_date and
      ...
      lrssetup:litigation_vendor<> 0 and
...
lrssetup:litigation_vendor/column=1
...
Sorted by lrssetup:litigation_vendor

end of lrssetup:litigation_vendor 
box/noheadings 
    lrssetup:litigation_vendor/column=1
    sfsvendor_cov:name/column=7/width=30/mask="XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX" 
    total[l_ctr,lrssetup:litigation_vendor]/column=40/mask="ZZ,ZZ9" 
    total[l_open_ctr,lrssetup:litigation_vendor]/column=50/mask="ZZ,ZZ9"
    total[l_closed_ctr,lrssetup:litigation_vendor]/column=60/mask="ZZ,ZZ9"
    total[l_reopen_ctr,lrssetup:litigation_vendor]/column=70/mask="ZZ,ZZ9" 
    total[lrsdetail:loss_paid,lrssetup:litigation_vendor]/mask="$ZZ,ZZZ,ZZZ.99-"/column=80
    total[lrsdetail:loss_resv,lrssetup:litigation_vendor]/mask="$ZZ,ZZZ,ZZZ.99-"/column=95
    total[lrsdetail:lae_paid,lrssetup:litigation_vendor]/mask="$ZZ,ZZZ,ZZZ.99-"/column=110
end box 
