/*  LRSPR634c
    ...
    Losses by Claim Number - Direct and ceded - by selected claim number

    Date Written : October 15, 2003

    SCIPS.com, Inc. */

description Losses by Selected Claim Number - Direct and Ceded - Detail - NET;

define unsigned ascii number l_enter_claim_no[11]=parameter/prompt=
"Enter Claim Number to View"
...
Define String l_prog_number = "LRSPR634C - Rev 4.00"

Include "lrs63ccal.inc"

include "lrscollect.inc"
and   lrsdetail:trans_date <= l_ending_date
and   lrsdetail:claim_no = l_enter_claim_no 

list
/nobanner
/domain="lrsdetail"
/title="Losses By Selected Claim Number - DIRECT and Ceded (NET)"
/pagewidth=255
/duplicates 
/nodetail                   
/nototals 
