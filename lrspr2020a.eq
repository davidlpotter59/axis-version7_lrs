/* lrspr2020a.eq
   ...
   daily Assigned Report by Adjustor
*/
                                         
description Daily Assigned Report - Sorted by Adjustor ;

include "startend.inc"                   

define string l_prog_number = "LRSPR2020a Daily Assigned Report - Adjuster "
...
where lrssetup:status = "O" and
      ...
      lrssetup:adjustor_vendor <> 0 
and sfsline:lob_code one of "AUTO"

list
/domain="lrssetup"
/nobanner    
/pagewidth=252  
/title="Daily Assigned Report Sorted by Adjuster"
/nodefaults 
--/duplicates 

box/noblanklines
lrssetup:adjustor_vendor/heading="Adjuster-Number"/duplicates/mask="ZZZZ"
...
lrssummary:claimant/heading="Claimant-Name"/duplicates 
lrssummary:loss_resv/heading="Loss-Resv"/noduplicates 
lrssummary:loss_paid/heading="Loss-Paid"/noduplicates 
...
sorted by lrssetup:adjustor_vendor/newpage/total 
          lrssetup:reported_date /total
          lrssetup:claim_no/newlines    

include "rpttopfw.inc"  
""/newline
alt_sfsvendor6:name[1]/heading="Adjuster"/newline=2
...
""/newline
count[lrssetup:units,lrssetup:adjustor_vendor]/heading=
