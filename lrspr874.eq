/*  LRSPR874
    ...
    Reserve Changes by a parameter amount - Property Only
...
description 
Reserve changes (Property Causes Only) by a selected amount - Requires user to enter the amount of change.  Also, this report uses a starting and ending date range.  The reserve will be compared to the prior period;

Define String l_prog_number = "LRSPR874 - Rev 4.00"
...
"<NL>Enter Reserve Amount to Report<NL>For example: 10000 <NL>"

include "lrscollect.inc" and
    lrsdetail:trans_date <= l_ending_date and
      lrsdetail:trans_code < 30 and
    sfscause:line_type = "P"

list
/nobanner
/domain="lrsdetail"
/title="Property Losses With Reserve Changes Equal or Greater Than Selected Amount"
/pagewidth=255
/duplicates
/nodetail
/nodefaults 
