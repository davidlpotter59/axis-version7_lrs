/* LRSPR003WC.EQ
   ...
   loss daily register - Workers Comp  */

description Totals by Transaction Register - Workers Comp;
...
WHERE LRSDETAIL:TRANS_DATE => L_STARTING_DATE AND
      ...
      sfsline:lob_code one of "WORK", "LOST", "MEDICAL" and
...
/PAGEWIDTH=250
/DUPLICATES
/title = "LOSS TRANSACTION REGISTER - WORKERS COMP"
/nopageheadings    
