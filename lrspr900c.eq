/*  LRSPR900
    ...
    Schedule P - Part 1 - Summary (losses by reported date / date of loss) - Ceded

    Date Written : November 3, 2003

    SCIPS.com, Inc. */

description Losses by Reported Date and Date of Loss (Schedule P - Part 1 - Summary) - Ceded;
...
Define String l_prog_number = "LRSPR900c - Rev 4.00"
...
sorted by l_report_year/newpage 
          l_loss_year
...
total[l_incurred,        l_report_year]/align=l_incurred
...
""/newline
l_report_year/heading="Reported Year"/newline 
