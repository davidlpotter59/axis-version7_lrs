/*  LRSPR534
    ...
    Losses by Claim Number - Net (Summary)

    Date Written : October 19, 2002

    SCIPS.com */

description Loss By Claim Number -Net (Summary) ;
             
define string l_name[10] = lrssetup:name[1]
Define String l_prog_number = "LRSPR534 - Rev 4.00"       
...
/nobanner
/domain="lrsdetail" 
/title="Losses By Claim Number - NET - Summary"
/pagewidth=220
/duplicates
/nodetail
/nopageheadings
