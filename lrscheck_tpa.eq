...
description 
Claims TPA check register, enter starting and ending dates, will print VOIDED checks with totals for VOIDED and page break;
...
where ((lrscheck:printed_date => l_starting_date and
        ...
        (lrscheck:release = "V" and 
         l_print_voided_checks one of "Y"))
        and apsaccount:tpa one of "Y"
