/*  lrspr711.eq
    ...
    losses by Examiner - Excel */

description Excel - Print Losses by Examinor ;
...
sfsvendor:examinor_name /heading="Name" /column=7/width=30
...
Sorted by lrssetup:examiner_no
