...
description Claims Closed With Payment Count within the following bands  91-180,181-365 days;

define unsigned ascii number l_days_to_settle  = ((claimcollection:status_date - claimcollection:reported_date) div 180)
...
where claimcollection:loss_paid <> 0 and 
     ...
     (claimcollection:status_date - claimcollection:reported_date) > 90 and 
     (claimcollection:status_date - claimcollection:reported_date) <= 365
                                                                                                                                   
sum
/nobanner
/domain="claimcollection"
/title="Homeowners Claims Closed With Payment"
