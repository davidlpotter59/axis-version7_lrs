/*  lrspr725.eq
    ...
    Report to print a selected ALL Claims with Direct and all Treaties - Transaction date processing
*/

description 
CLAIM DETAIL REPORT -- Enter a starting and ending date range - this report will list the direct details, ceded and then total (NET) the claim - Transaction date processing not Incurred;
...
/noreporttotals  
/title=
"LRSDETAIL Transaction Details - ALL Claims - Transaction Date Processing "
