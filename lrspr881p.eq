...
description 
Losses By Claim Number - direct incurred - $ select direct losses reported only by the range selected => $ Property - Positive;

define string l_claim_no = str(lrsdetail:claim_no) + trun(sfsline_alias:claim_alpha
)

Define String l_prog_number = "LRSPR881p - Rev 2.00"
