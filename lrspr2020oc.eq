...
where lrssetup:status one of "O", "C" and
...
switch(lrssetup:status)
  ...
  case "C" : "CLOSED"
lrssetup:loss_date/heading="Date Of-Loss"/newline
...
sorted by l_vendor_6
          lrssetup:claim_no   

end of l_vendor_6
""/newline                                                                
"NUMBER OF CLAIMS FOR ADJUSTER:"/column=120
count[lrssetup:claim_no]/noheading/column=155/newline

include "rpttopfw.inc"

end of report
""/newline
"TOTAL NUMBER OF CLAIMS:"/column=120
count[lrssetup:claim_no]/noheading/column=155/newline
