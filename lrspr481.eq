/*  SCIPS.com, Inc.
    ...
    Claim counts - Direct only - Sorted by Date of Loss / Annual Statement Line
*/

Description Direct Claim counts by Date of Loss / Annual Statement Line of Business ;

include "startend.inc"

define unsigned ascii number l_DOL_year[4] = year(lrssetup:loss_date)
...
top of l_DOL_YEAR 
l_dol_year/column=1/heading="Date of Loss"/newline 
