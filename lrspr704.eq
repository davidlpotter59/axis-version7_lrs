/*  lrspr704
    ...
    Losses by Subrogation Vendor*/

description  Subrogation Vendor Adjustors Totals ;
...
where lrsdetail:trans_date >= l_starting_date and
      ...
      lrssetup:subro_vendor<> 0 and
      lrsdetail:trans_code < 30
list
/nobanner           
/title="Claims By Subrogation Vendor Opinion"
/domain="lrssetup" 
/nodetail
/pagewidth=150
/noreporttotals 

lrssetup:subro_vendor/column=1
...
Sorted by lrssetup:subro_vendor/newlines=2

end of lrssetup:subro_vendor 
box/noheadings 
    lrssetup:subro_vendor/column=1
    sfsvendor_cov:name/column=7/width=30/mask="XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX" 
    total[l_ctr,lrssetup:subro_vendor]/column=40/mask="ZZ,ZZ9" 
    total[l_open_ctr,lrssetup:subro_vendor]/column=50/mask="ZZ,ZZ9"
    total[l_closed_ctr,lrssetup:subro_vendor]/column=60/mask="ZZ,ZZ9"
    total[l_reopen_ctr,lrssetup:subro_vendor]/column=70/mask="ZZ,ZZ9" 
    total[lrsdetail:loss_paid,lrssetup:subro_vendor]/mask="$ZZ,ZZZ,ZZZ.99-"/column=80
    total[lrsdetail:loss_resv,lrssetup:subro_vendor]/mask="$ZZ,ZZZ,ZZZ.99-"/column=95
    total[lrsdetail:lae_paid,lrssetup:subro_vendor]/mask="$ZZ,ZZZ,ZZZ.99-"/column=110
end box 
