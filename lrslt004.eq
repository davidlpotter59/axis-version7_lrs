/* lrslt004.eq
   ...
   Claim Acknowledgment letter - Documentation Needed
...
"We are in receipt of your claim, which I have been assigned to handle."
/newline=2
"In order to process your claim, please send me the Following: "/newline
if lrssetup_work:police_report = 1 then
"    Please forward Police Report"/newline
if lrssetup_work:complete_attached = 1 then
"    Please Complete the Attached"/newline
if lrssetup_work:photo = 1 then
"    Please forward Photo of Damage"/newline
" "/newline
"Please complete the attached theft forms and forward then along with invoices "/newline
"for stolen items."/newline=2
