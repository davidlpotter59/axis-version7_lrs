/*  lrspr710.eq
    ...
    Report to print a selected ALL Claims with Direct and all Treaties
*/

description 
CLAIM DETAIL REPORT -- Enter a starting and ending date range - this report will list the direct details, ceded and then total (NET) the claim ;
...
/pagewidth=190
/noreporttotals  
/title="LRSDETAIL Transaction Details - ALL Claims "
