...
description Loss By Claim Number - Ceded - Sortd by Reinsurance Company Code  ;
             
define string l_name[10] = lrssetup:name[1]
Define String l_prog_number = "LRSPR542 - Rev 4.00"       
...
sorted by lrsdetail:reins_co /newpage/total 
          lrsdetail:claim_no
...
""/newline 
lrsdetail:reins_co/heading="Reinsurance Treaty "/newline
