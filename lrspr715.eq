/*  lrspr715.eq
    ...
    Report to print a selected Claim with Direct and all Treaties  - Transaction Date selected
*/

description 
Enter a starting and ending date range as well as a claim number and this report will list the direct details, ceded and then total (NET) the claim.  This report will list based on transaction date and not incurred dates ;
...
/pagewidth=190
/noreporttotals  
/title="LRSDETAIL Audit Report - By Claim Number - Transaction Date Processing"
